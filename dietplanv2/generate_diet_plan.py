...
def generate_diet_plan(user_data):
    ...
    check_and_modify_prompt = (
        ...
        f"Eliminate any items that contain these allergens or disliked foods and modify the diet plan accordingly. GENERARTE ONLY THE MEALS, WITHOUT ANY TITLE OR FURTHER INFORMATION"
    )
...
if __name__ == '__main__':
    ...
    with open('diet_plan.json', 'w') as file:
        json.dump({'diet_plan': diet_plan}, file)
